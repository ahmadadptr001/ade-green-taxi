  ...
  const handleSave = async () => {
    ...
    Swal.fire({
      ...
      customClass: {
        ...
        confirmButton:
          'bg-indigo-600 rounded-xl px-6 py-3 font-medium shadow-lg shadow-indigo-200',
      },
              ...
              <div className="p-6 rounded-2xl bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-100/60 relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col gap-3">
                  ...
                  <p className="text-sm text-amber-800/80 leading-relaxed">
                    Teks yang Anda masukkan akan langsung ditayangkan pada baris
                    utama (headline) running text website. Pastikan ejaan sudah
                    benar.
                  </p>
                </div>
              </div>
