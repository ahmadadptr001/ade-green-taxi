      ...
      <div className="hidden md:flex md:w-[45%] bg-slate-900 relative overflow-hidden items-center justify-center p-12">
        ...
        <div className="relative z-10 max-w-sm">
          ...
          <p className="text-slate-400 text-lg leading-relaxed mb-10">
            Bergabunglah dengan ribuan agen perubahan untuk masa depan yang
            lebih berkelanjutan.
          </p>
        ...
        <div className="w-full max-w-[400px] mt-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              >
                <User
                  className={`w-5 h-5 mr-3 ${focusedField === 'name' ? 'text-emerald-500' : 'text-slate-400'}`}
                />
                <input
                  type="text"
            ...
            <div className="space-y-2">
              ...
              >
                <Mail
                  className={`w-5 h-5 mr-3 ${focusedField === 'email' ? 'text-emerald-500' : 'text-slate-400'}`}
                />
                <input
                  type="email"
            ...
            <div className="space-y-2">
              ...
              >
                ...
                />
                <Smartphone
                  className={`w-5 h-5 ${focusedField === 'whatsapp' ? 'text-emerald-500' : 'text-slate-400'}`}
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div
                className={`
                flex items-center border rounded-2xl px-4 py-4 transition-all duration-300
                ${focusedField === 'password' ? 'border-emerald-500 ring-4 ring-emerald-50' : 'border-slate-100 bg-slate-50'}
              `}
              >
                <Key
                  className={`w-5 h-5 mr-3 ${focusedField === 'password' ? 'text-emerald-500' : 'text-slate-400'}`}
                />
                <input
          ...
          <div className="mt-12 text-center">
            <p className="text-slate-400 text-sm font-medium">
              ...
              <Link
                href={'/masuk'}
                className="text-emerald-600 font-bold hover:text-emerald-700 underline decoration-emerald-200 underline-offset-8 decoration-2 transition-all"
              >
                Masuk ke Akun
              </Link>
            </p>
