          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-20">
            <div className="md:col-span-5">
              <div className="flex items-center gap-3 mb-8">
                <div className="h-12 w-12 bg-emerald-500 rounded-2xl flex items-center justify-center text-2xl font-black italic">
                  A
                </div>
                <span className="text-3xl font-black tracking-tighter">
                  ADE<span className="text-emerald-500">NEWS</span>
                </span>
              </div>
              <p className="text-slate-400 text-lg leading-relaxed max-w-sm font-medium">
                Mendefinisikan ulang jurnalisme modern dengan akurasi,
                integritas, dan kecepatan.
              </p>
            </div>
