  ...
  return (
    <>
      ...
      <header className="fixed left-1/2 top-3 z-[120] w-[calc(100%-1rem)] -translate-x-1/2 md:w-auto">
        <div className="flex items-center gap-2 rounded-full border border-slate-200 bg-white/90 px-2 py-2 shadow-sm shadow-slate-900/5 backdrop-blur-md md:gap-4 md:px-4">
          ...
          <form
            ...
            className="flex flex-1 items-center gap-2 rounded-full bg-slate-100 px-3 py-1.5 md:hidden"
          >
          ...
          <div className="mx-0.5 hidden h-4 w-px bg-slate-200 md:block" />
          ...
          <button
            ...
            className="hidden items-center gap-1 text-sm font-medium text-slate-600 transition-colors hover:text-slate-900 md:flex"
          >
            <Globe size={15} />
            {language === "id" ? "ID" : "EN"}
          </button>
          ...
          <button
            ...
            onClick={() => setOpen((v) => !v)}
            className="shrink-0 rounded-full p-1.5 text-slate-600 transition-colors hover:bg-slate-100 md:hidden"
          >
        ...
        <div
          className={`absolute left-1/2 top-full mt-2 hidden w-[min(92vw,36rem)] -translate-x-1/2 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-lg shadow-slate-900/5 transition-all duration-300 md:block ${
            searchOpen
