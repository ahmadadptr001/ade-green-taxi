        ...
        <div className="max-w-6xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-10 items-center">
          <div className="space-y-6">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              <a href="/beranda/tentang" className="underlien text-sky-400">
                Ade Green TX
              </a>
              {isID
                ? "adalah brand aplikasi Eco Mobility yang dikembangkan untuk menghadirkan solusi transportasi ramah lingkungan di Kendari. Kami mengintegrasikan teknologi dan mobilitas berkelanjutan untuk mendukung pergerakan masyarakat yang lebih efisien, modern, dan peduli lingkungan."
                : "is an Eco Mobility application brand developed to provide sustainable transportation solutions in Kendari. We integrate technology and green mobility to create efficient, modern, and environmentally responsible movement for the community."}
            </p>
