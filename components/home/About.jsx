...
import { Leaf, Car, CreditCard, ShieldCheck, Search } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <p className="text-lg text-gray-600  leading-relaxed mb-10 max-w-xl">
            <a
              className="underline text-sky-500 flex gap-1"
              href={"/beranda/tentang"}
            >
              Ade Green TX
              <Search className="transform rotate-90" size={12} />
            </a>
            {language === "en"
              ? "is an electric-based ride-hailing service designed to deliver clean, affordable, and reliable mobility for urban life."
              : "adalah layanan transportasi berbasis kendaraan listrik yang menghadirkan mobilitas bersih, hemat, dan terpercaya."}
          </p>
